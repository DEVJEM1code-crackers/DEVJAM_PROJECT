  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      PersistentBottomNavBarItem(
        icon: Icon(Icons.home, size: 26, color: kWhiteColor),
        inactiveIcon: Icon(Icons.home, size: 26, color: kPrimaryColor),activeColorSecondary: kWhiteColor,
        title: ("Home"),
        activeColorPrimary: kPrimaryColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
      PersistentBottomNavBarItem(
        icon: Icon(Icons.search, size: 26, color: kWhiteColor),
        inactiveIcon: Icon(Icons.search, size: 26, color: kPrimaryColor),
      ...
      PersistentBottomNavBarItem(
        icon: Icon(Icons.account_tree, size: 26, color: kWhiteColor),
        inactiveIcon: Icon(Icons.account_tree, size: 26, color: kPrimaryColor),activeColorSecondary: kWhiteColor,
        title: ("help"),
        activeColorPrimary: kPrimaryColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
